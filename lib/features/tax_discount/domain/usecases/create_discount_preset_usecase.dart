// lib/features/tax_discount/domain/usecases/create_discount_preset_usecase.dart
...
class CreateDiscountPresetUsecase {
  final DiscountRepository _repository;

  const CreateDiscountPresetUsecase(this._repository);
  ...
  Future<Either<Failure, DiscountPresetEntity>> call({
    ...
    final discount = DiscountPresetEntity(
    ...
    return _repository.createDiscountPreset(discount);
  }
}
